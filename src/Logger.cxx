...
const std::string  MODULE_NAME           = "SMP";
...
const std::string  EV_MODULE_LOGLEVEL    = "SMP_LOGLEVEL";        // This modules log level
const std::string  EV_MODULE_LOGFILEPATH = "SMP_LOGFILEPATH";     // This modules log full log filename
